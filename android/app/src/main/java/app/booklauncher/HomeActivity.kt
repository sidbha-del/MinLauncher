...
import app.booklauncher.data.Scanner
import app.booklauncher.reader.ReaderActivity
import app.booklauncher.ui.HomeScreen
import app.booklauncher.ui.InkPalette
import app.booklauncher.ui.PageLook
import app.booklauncher.ui.Screen
import app.booklauncher.ui.setBarIcons
import app.booklauncher.ui.SetupScreen
import app.booklauncher.ui.Ui
import app.booklauncher.ui.applyEdgeToEdgeInsets
...
class HomeActivity : Activity() {
    ...
    fun launchApp(entry: AppCatalog.Entry) {
        ...
        if (prefs.pauseEnabled && app.booklauncher.data.Focus.isDistracting(prefs, catalog, pkg)) {
            app.booklauncher.ui.PauseSheet.show(this, entry)
            return
        }
